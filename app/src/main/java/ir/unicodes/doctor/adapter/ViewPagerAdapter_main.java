...
public class ViewPagerAdapter_main extends PagerAdapter {
    ...
    public ViewPagerAdapter_main(Context context, List<String> myList, boolean isCash) {
        ...
        Drawable[] stt = {
                ...
                context.getResources().getDrawable(R.drawable.bime),
                context.getResources().getDrawable(R.drawable.moraqebatha),
                context.getResources().getDrawable(R.drawable.services),
                context.getResources().getDrawable(R.drawable.calculate)
        };
        sttr = stt;
    }// end Cunstractor()
